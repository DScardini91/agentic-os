...
| D-008 | 2026-06-27 | meta | Version bump to v1.2.1: Enhanced SessionStart/Stop hook lifecycle — state-drift-check, memory-ttl-compaction, canon-recheck-due, validate-harness integrated into harness initialization/cleanup. SessionStart hooks expanded from 6 to 10; Stop hooks expanded from 2 to 4. All new hooks non-blocking (error suppression via `2>/dev/null \|\| true`), fully idempotent, safe for repeated invocation. Total enforcement surface across lifecycle: 20+ scripts. Supports operator-defined agents, 3-layer memory, and governance via decision-log. Ready for distribution. | yes | agentic-os-v1.2.1.zip |
| D-009 | 2026-07-10 | meta | Version bump to v2.3.0: Codex-facing runtime contracts added via root AGENTS.md + control-plane/AGENTS.md, context-budget promoted to public best practice, and agentic-os-reference-sync skill added to make private-reference-to-public-template updates repeatable and sanitized. Claude Code remains reference runtime for deterministic hooks; Codex orientation is explicit but does not claim automatic hook parity. | yes | AGENTS.md, control-plane/AGENTS.md, .claude/skills/agentic-os-reference-sync/SKILL.md, CHANGELOG.md |
